...
import { BarChart3, ChevronDown, Home, LayoutDashboard, LifeBuoy, Package, Settings, Users } from "lucide-react"
  ...
  return (
    <Sidebar>
      <SidebarHeader className="flex h-14 items-center border-b px-4 bg-background">
        ...
        <span className="text-2xl text-muted-foreground group-data-[collapsible=icon]:hidden">Shadcn UI Styler</span>
      </SidebarHeader>
            ...
            <Collapsible defaultOpen className="w-full">
              <SidebarMenuItem className="flex flex-col items-start">
                <CollapsibleTrigger className="flex w-full items-center gap-2 rounded-md p-2 text-sm hover:bg-accent hover:text-accent-foreground">
                  ...
                  <span className="flex-1 group-data-[collapsible=icon]:hidden">Analytics</span>
            ...
            <Collapsible defaultOpen className="w-full">
              <SidebarMenuItem className="flex flex-col items-start">
                <CollapsibleTrigger className="flex w-full items-center gap-2 rounded-md p-2 text-sm hover:bg-accent hover:text-accent-foreground">
                  ...
                  <span className="flex-1 group-data-[collapsible=icon]:hidden">Users</span>
                  <ChevronDown className="h-4 w-4 transition-transform duration-200 group-data-[state=open]/collapsible:rotate-180 group-data-[collapsible=icon]:hidden" />
                </CollapsibleTrigger>
                <CollapsibleContent className="w-full pl-4 group-data-[collapsible=icon]:hidden">
                  <SidebarMenu>
            ...
            <Collapsible defaultOpen className="w-full">
              <SidebarMenuItem className="flex flex-col items-start">
                <CollapsibleTrigger className="flex w-full items-center gap-2 rounded-md p-2 text-sm hover:bg-accent hover:text-accent-foreground">
                  ...
                  <span className="flex-1 group-data-[collapsible=icon]:hidden">Settings</span>
                  <ChevronDown className="h-4 w-4 transition-transform duration-200 group-data-[state=open]/collapsible:rotate-180 group-data-[collapsible=icon]:hidden" />
                </CollapsibleTrigger>
                <CollapsibleContent className="w-full pl-4 group-data-[collapsible=icon]:hidden">
                  <SidebarMenu>
